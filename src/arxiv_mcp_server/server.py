...
from .tools import handle_search, handle_download, handle_list_papers, handle_read_paper, handle_search_cif, handle_check_cif
from .tools import search_tool, download_tool, list_tool, read_tool, search_cif_tool, check_cif_tool
...
async def list_tools() -> List[types.Tool]:
    ...
    return [search_tool, download_tool, list_tool, read_tool, search_cif_tool, check_cif_tool]
...
async def call_tool(name: str, arguments: Dict[str, Any]) -> List[types.TextContent]:
    ...
    try:
        ...
        elif name == "search_cif":
            return await handle_search_cif(arguments)
        elif name == "check_cif":
            return await handle_check_cif(arguments)
        else:
